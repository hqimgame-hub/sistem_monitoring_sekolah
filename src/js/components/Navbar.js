...
export function renderNavbar({ title, userEmail, onLogout }) {
  // Pastikan element navbar belum ada
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="#" class="flex ms-2 md:ms-4">
              ...
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">${title}</span>
            </a>
          </div>
          <div class="flex items-center">
              <div class="flex items-center ms-3">
                <div class="flex items-center gap-3">
                    <span class="hidden sm:block text-sm text-white font-medium">${userEmail || 'User'}</span>
